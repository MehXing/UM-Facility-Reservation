						...
						<div class="container-fluid">
							<div class="collapse navbar-collapse" id="collapsableNav">
								<a class="navbar-brand p-3" href="Home.php">
									<img src="img/um-seal.png" alt="Logo" style="width:50px;">
								</a>
								<ul class="navbar-nav">
									<li class="nav-item">
										<a class="nav-link text-light p-3 text-white" href="Home.php">Home</a>
									</li>
								</ul>
							</div>
							<div class="collapse navbar-collapse justify-content-end" id="collapsableNav">
								<ul class="navbar-nav">
									<li class="nav-item">
										<a class="nav-link text-light p-3 text-white" href="Register.php">Register</a>
									</li>
									<li class="nav-item">
										<a class="nav-link text-light p-3 text-white" href="Login.php">Login</a>
									</li>
								</ul>
							</div>
						</div>
